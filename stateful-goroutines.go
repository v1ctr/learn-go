...
func main() {
	...
	// A response is executed by first performing the requested operation and then sending a value on the response channel
	// resp to indicate success (and the desired value in the case of reads).
	go func() {
